...
// Batch 10 page: "No agency-management vendor sync (AMS360, Vertafore)" (nonai-gap) — insuranceAgency
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-agency-management-vendor-sync-ams360";
const LABEL = "No agency-management vendor sync (AMS360, Vertafore)";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-agency-management-vendor-sync-ams360";

export default function NoAgencyManagementVendorSyncAms360Page() {
