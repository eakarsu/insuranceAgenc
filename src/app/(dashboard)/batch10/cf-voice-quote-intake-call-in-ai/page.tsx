...
// Batch 10 page: "Voice quote intake (call in, AI quotes in real time)" (cfs) — insuranceAgency
'use client';
import { useEffect, useState } from 'react';

const SLUG = "voice-quote-intake-call-in-ai";
const LABEL = "Voice quote intake (call in, AI quotes in real time)";
const SECTION = "cfs";
const API_PATH = "/api/cf-voice-quote-intake-call-in-ai";

export default function VoiceQuoteIntakeCallInAiPage() {
