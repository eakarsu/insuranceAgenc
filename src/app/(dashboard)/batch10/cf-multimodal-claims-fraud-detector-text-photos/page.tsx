...
// Batch 10 page: "Multimodal claims fraud detector (text + photos + patterns)" (cfs) — insuranceAgency
'use client';
import { useEffect, useState } from 'react';

const SLUG = "multimodal-claims-fraud-detector-text-photos";
const LABEL = "Multimodal claims fraud detector (text + photos + patterns)";
const SECTION = "cfs";
const API_PATH = "/api/cf-multimodal-claims-fraud-detector-text-photos";

export default function MultimodalClaimsFraudDetectorTextPhotosPage() {
