...
// Batch 10 page: "No automated ACORD form ingestion / output" (nonai-gap) — insuranceAgency
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-automated-acord-form-ingestion-output";
const LABEL = "No automated ACORD form ingestion / output";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-automated-acord-form-ingestion-output";

export default function NoAutomatedAcordFormIngestionOutputPage() {
