...
// Batch 10 page: "No reinsurance / treaty analytics AI" (ai-gap) — insuranceAgency
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-reinsurance-treaty-analytics-ai";
const LABEL = "No reinsurance / treaty analytics AI";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-reinsurance-treaty-analytics-ai";

export default function NoReinsuranceTreatyAnalyticsAiPage() {
