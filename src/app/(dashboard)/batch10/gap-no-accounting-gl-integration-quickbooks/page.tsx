...
// Batch 10 page: "No accounting / GL integration (QuickBooks)" (nonai-gap) — insuranceAgency
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-accounting-gl-integration-quickbooks";
const LABEL = "No accounting / GL integration (QuickBooks)";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-accounting-gl-integration-quickbooks";

export default function NoAccountingGlIntegrationQuickbooksPage() {
