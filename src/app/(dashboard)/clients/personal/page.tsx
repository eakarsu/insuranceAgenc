  ...
  return (
    <Box className="animate-fade-in">
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box>
          <Typography variant="h4" fontWeight={700} gutterBottom>Personal Lines Clients</Typography>
          <Typography color="text.secondary">Manage individual/personal insurance clients</Typography>
        </Box>
      ...
      <Card sx={{ mb: 3, p: 2 }}>
        <TextField
          placeholder="Search personal clients..."
          value={search}
