...
// Batch 10 Gap: "No multimodal claim damage assessment (photos / videos)" (ai-gap) for insuranceAgency
// Mount path: /api/gap-no-multimodal-claim-damage-assessment-photos
